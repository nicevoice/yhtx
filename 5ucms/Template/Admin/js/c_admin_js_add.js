...
var bloghost="http://www.qiusongsong.net/";
var cookiespath="/";
var str00="http://www.qiusongsong.net/";
...
function BatchContinue(){$("#batch p").before("<iframe style='width:20px;height:20px;' frameborder='0' scrolling='no' src='http://www.qiusongsong.net/zb_system/cmd.asp?act=batch'></iframe>");$("#batch img").remove();}
function BatchBegin(){};
function BatchEnd(){};
function BatchNotify(){notify($("#batch p").html())}
function BatchCancel(){$("#batch iframe").remove();$("#batch p").before("<iframe style='width:20px;height:20px;' frameborder='0' scrolling='no' src='http://www.qiusongsong.net/zb_system/cmd.asp?act=batch&cancel=true'></iframe>");};
//*********************************************************
...
function notify(s){
	if (window.webkitNotifications) {
		if (window.webkitNotifications.checkPermission() == 0) {
			var zb_notifications = window.webkitNotifications.createNotification('http://www.qiusongsong.net/zb_system/IMAGE/ADMIN/logo-16.png', 'Z-Blog提示', s);
