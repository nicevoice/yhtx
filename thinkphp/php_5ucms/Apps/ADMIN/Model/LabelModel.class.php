...
class LabelModel extends Model{
    ...
    protected $_validate        =   array(
		...
		array('name','1,200','标签名称长度必须在1-200范围内',1,'length',3), 
		array('name','','标签名称存在！',0,'unique',1), // 在新增的时候验证值是否唯一
        array('info','1,200','标签说明长度必须在1-200范围内',1,'length',3), 
    ); 
