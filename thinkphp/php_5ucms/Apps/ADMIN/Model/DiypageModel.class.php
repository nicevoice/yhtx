...
class DiypageModel extends Model{
    ...
    protected $_validate        =   array(
        ...
        //验证用户名,require必须填写项目
        array('dir','require','路径必须填写'),
		array('dir','5,200','路径长度必须在5-200范围内',1,'length',3),
		array('dir','','路径已经存在！',0,'unique',1), // 在新增的时候验证值是否唯一
        array('title','1,200','名称长度必须在1-200范围内',1,'length',3), 
    ); 
